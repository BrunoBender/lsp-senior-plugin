...
/**
 * Coletor de sticky lines (linhas fixas / sticky scroll) para arquivos .lsp / .lspt.
 *
 ...
 * - [computeCrumbs]: retorna vazio de propósito — a barra de breadcrumbs foi desativada;
 *   as sticky lines já cumprem esse papel de forma menos intrusiva.
 */
class LspBreadcrumbsCollector : FileBreadcrumbsCollector() {
    ...
    // Barra de breadcrumbs desativada: sem crumbs, a barra não aparece. As sticky lines
    // (computeStickyLineInfos) continuam funcionando de forma independente.
    override fun computeCrumbs(
        file: VirtualFile,
        document: Document,
        offset: Int,
        forcedShown: Boolean?,
    ): Iterable<Crumb> = emptyList()
